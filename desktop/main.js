...
// (New Application → skopiuj "Application ID"). Bez niego integracja po prostu
// się nie włącza i aplikacja działa jak dotąd.
const DISCORD_APP_ID = process.env.SOUNDWAVE_DISCORD_APP_ID || '';
